...
libraries <- c("labelled","SmartEDA","epitools","ggplot2","pandoc","compareGroups","epiR")
...
png(file="1.1 - Incidence of Walkovers in WTA tennis matches by year (1975-2019).png", width=800, height=600)
